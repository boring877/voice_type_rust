...
pub use constants::{
    ...
    DEFAULT_SILENCE_THRESHOLD, GRAMMAR_PROFILE_BALANCED, GRAMMAR_PROFILE_FAST,
    GRAMMAR_PROFILE_QUALITY, HUD_BACKGROUND_MODE_GLASS, HUD_BACKGROUND_MODE_IMAGE,
    HUD_SIDE_LEFT, HUD_SIDE_RIGHT, PROVIDER_GROQ, SINGLE_INSTANCE_ID, THEME_DARK, THEME_LIGHT,
};

// Re-export functions from manager
pub use manager::{backgrounds_dir, has_api_key, load, save};
